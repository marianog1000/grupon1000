...
class Installer extends Base\Installer
{
    ...
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            // Cron.
            'bookly_cron_reminder_times'                 => array( 'client_follow_up' => 21, 'client_reminder' => 18, 'client_birthday_greeting' => 9, 'staff_agenda' => 18 ),
            // Grace.
    ...
    public function createTables()
    {
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . \Bookly\Lib\Entities\StatsForms::getTableName() . '` (
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . \Bookly\Lib\Entities\StatsSteps::getTableName() . '` (
