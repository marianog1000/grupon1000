    ...
    public function index()
    {
        ...
        wp_localize_script( 'bookly-calendar.js', 'BooklyL10n', array(
            ...
            'recurring_appointments' => array(
                'enabled' => (int) Lib\Config::isRecurringAppointmentsEnabled(),
    ...
    public function executeGetDataForAppointment()
    {
        ...
        if ( $appointment->load( $this->getParameter( 'id' ) ) ) {
            ...
            $info = Lib\Entities\Appointment::query( 'a' )
                ->select( 'ss.capacity AS max_capacity, SUM( ca.number_of_persons ) AS total_number_of_persons, a.staff_id, a.service_id, a.start_date, a.end_date, a.internal_note, a.series_id' )
