jQuery(function ($) {
    ...
    $fullCalendar.fullCalendar({
        ...
        eventRender : function (calEvent, $event) {
            ...
            if (BooklyL10n.recurring_appointments.enabled == '1' && calEvent.series_id) {
                body += '<a class="bookly-show-series dashicons dashicons-admin-links" title="' + BooklyL10n.recurring_appointments.title + '"></a>';
            }
            body += '<a class="bookly-delete-event dashicons dashicons-trash" title="' + BooklyL10n.delete + '"></a>';
