            ...
            switch ( $this->getParameter( 'tab' ) ) {
                ...
                case 'general':  // General form.
                    ...
                    if ( \Bookly\Lib\Plugin::getPurchaseCode() ) {
                        if ( $this->getParameter( 'bookly_gen_collect_stats' ) ) {
                            if ( ! get_option( 'bookly_gen_collect_stats' ) ) { // if we'r changing from disabled to enabled
                                update_option( 'bookly_gen_collect_stats', '2' ); // that option was set not by default, but knowingly
                            }
                        } else {
                ...
                default:
                    ...
                    \Bookly\Backend\Modules\License\Components::getInstance()->renderLicenseRequired();
            }
