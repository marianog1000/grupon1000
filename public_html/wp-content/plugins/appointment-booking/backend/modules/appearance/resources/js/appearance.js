jQuery(function($) {
    var // Progress Tracker.
        ...
        $text_repeat_no_available_slots = $('#bookly_l10n_repeat_no_available_slots'),
        $text_step_repeat     = $('#bookly_l10n_step_repeat'),
        // Next buttons
        $text_step_service_button_next = $('#bookly_l10n_step_service_button_next'),
        $text_step_service_mobile_button_next = $('#bookly_l10n_step_service_mobile_button_next'),
        $text_step_extras_button_next  = $('#bookly_l10n_step_extras_button_next'),
        $text_step_repeat_button_next  = $('#bookly_l10n_step_repeat_button_next'),
        $text_step_cart_button_next    = $('#bookly_l10n_step_cart_button_next'),
        $text_step_details_button_next = $('#bookly_l10n_step_details_button_next'),
        $text_step_payment_button_next = $('#bookly_l10n_step_payment_button_next')
    ;
    ...
    $save_button.on('click', function(e) {
        ...
        var data = {
            ...
            options: {
                ...
                'text_repeat_no_available_slots' : getEditableValue($text_repeat_no_available_slots.text()),
                ...
                'text_step_repeat_button_next' : getEditableValue($text_step_repeat_button_next.text()),
                // Buttons Next.
                'text_step_service_button_next': getEditableValue($text_step_service_button_next.text()),
                'text_step_service_mobile_button_next': getEditableValue($text_step_service_mobile_button_next.text()),
                'text_step_extras_button_next' : getEditableValue($text_step_extras_button_next.text()),
                'text_step_cart_button_next'   : getEditableValue($text_step_cart_button_next.text()),
                'text_step_details_button_next': getEditableValue($text_step_details_button_next.text()),
                'text_step_payment_button_next': getEditableValue($text_step_payment_button_next.text()),
                // Validator.
