    ...
    <div class="bookly-service-step">
        ...
        <div class="ab-mobile-step_1 bookly-box">
            <div class="bookly-js-chain-item bookly-table bookly-box">
                ...
                <?php endif ?>
                <div class="ab-formGroup">
                    <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_category', 'bookly_l10n_option_category', ) ) ?>
                    <div>
                ...
                <div class="ab-formGroup">
                    <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array(
                ...
                <div class="ab-formGroup">
                    <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_number_of_persons', ) ) ?>
                    <div>
            ...
            <div class="ab-right ab-mobile-next-step ab-btn ab-none">
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_step_service_mobile_button_next' ) ) ?>
            </div>
        </div>
        <div class="ab-mobile-step_2">
            <div class="bookly-box">
                <div class="ab-left">
                    <div class="ab-available-date ab-left">
                        <div class="ab-formGroup">
                            <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_select_date', ) ) ?>
                            <div>
                ...
                <div class="ab-time-range ab-left">
                    <div class="ab-formGroup ab-time-from ab-left">
                        <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_start_from', ) ) ?>
                        <div>
                    ...
                    <div class="ab-formGroup ab-time-to ab-left">
                        <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_finish_by', ) ) ?>
                        <div>
            ...
            <div class="bookly-box bookly-nav-steps">
                <div class="ab-right ab-mobile-prev-step ab-btn ab-none">
                    <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_button_back' ), 'bookly-js-text-back' ) ?>
                </div>
                <div class="bookly-next-step ab-btn">
                    <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_step_service_button_next' ) ) ?>
                </div>
                <button class="bookly-go-to-cart bookly-round bookly-round-md ladda-button"><span><img src="<?php echo plugins_url( 'appointment-booking/frontend/resources/images/cart.png' ) ?>" /></span></button>
            </div>
        </div>
    </div>
</div>
