...
<div class="bookly-form">
    ...
    <div class="ab-details-step">
        <div class="bookly-box bookly-table">
            <div class="ab-formGroup">
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_name', 'bookly_l10n_required_name', ) ) ?>
                <div>
                    <input type="text" value="" maxlength="60" />
                </div>
            </div>
            <div class="ab-formGroup">
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_phone', 'bookly_l10n_required_phone', ) ) ?>
                <div>
                    <input type="text" class="<?php if ( get_option( 'bookly_cst_phone_default_country' ) != 'disabled' ) : ?>ab-user-phone<?php endif ?>" value="" />
                </div>
            </div>
            <div class="ab-formGroup">
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderLabel( array( 'bookly_l10n_label_email', 'bookly_l10n_required_email', ) ) ?>
                <div>
    ...
    <div class="bookly-box bookly-nav-steps">
        ...
        <div class="bookly-next-step ab-btn">
            <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_step_details_button_next' ) ) ?>
        </div>
    </div>
</div>
