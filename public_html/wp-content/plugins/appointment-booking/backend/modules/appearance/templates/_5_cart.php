...
<div class="bookly-form">
    ...
    <div class="bookly-box">
        <div class="ab-btn ab-add-item ab-inline-block">
            <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_button_book_more', ) ) ?>
        </div>
    </div>
    ...
    <div class="bookly-box bookly-nav-steps">
        ...
        <div class="bookly-next-step ab-btn">
            <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_step_cart_button_next' ) ) ?>
        </div>
    </div>
</div>
