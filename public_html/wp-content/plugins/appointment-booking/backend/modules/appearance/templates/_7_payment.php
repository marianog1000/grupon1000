...
<div class="bookly-form">
    ...
    <div class="bookly-box ab-list">
        <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_label_coupon', ) ) ?>
        <div class="ab-inline-block">
            <input class="ab-user-coupon" type="text" />
            <div class="ab-btn btn-apply-coupon">
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_button_apply', ) ) ?>
            </div>
        </div>
    </div>
    <div class="ab-payment-nav">
        ...
        <div class="bookly-box ab-list">
            <label>
                ...
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_label_pay_locally', ) ) ?>
            </label>
        </div>
        ...
        <div class="bookly-box ab-list">
            <label>
                ...
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_label_pay_paypal', ) ) ?>
        ...
        <div class="bookly-box ab-list">
            <label>
                ...
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_label_pay_ccard', ) ) ?>
        ...
        <div class="bookly-box ab-list">
            <label>
                <input type="radio" name="payment" />
                <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_label_pay_mollie', ) ) ?>
    ...
    <div class="bookly-box bookly-nav-steps">
        ...
        <div class="bookly-next-step ab-btn">
            <?php \Bookly\Backend\Modules\Appearance\Lib\Helper::renderSpan( array( 'bookly_l10n_step_payment_button_next' ) ) ?>
        </div>
    </div>
</div>