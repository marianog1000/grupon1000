    ...
    public function executeUpdateAppearanceOptions()
    {
        if ( $this->hasParameter( 'options' ) ) {
            ...
            $options = array(
                ...
                'bookly_l10n_step_service_mobile_button_next'=> $get_option['text_step_service_mobile_button_next'],
                'bookly_l10n_step_service_button_next'=> $get_option['text_step_service_button_next'],
                'bookly_l10n_step_time'               => $get_option['text_step_time'],
                'bookly_l10n_step_cart'               => $get_option['text_step_cart'],
                'bookly_l10n_step_cart_button_next'   => $get_option['text_step_cart_button_next'],
                'bookly_l10n_step_details'            => $get_option['text_step_details'],
                'bookly_l10n_step_details_button_next'=> $get_option['text_step_details_button_next'],
                'bookly_l10n_step_payment'            => $get_option['text_step_payment'],
                'bookly_l10n_step_payment_button_next'=> $get_option['text_step_payment_button_next'],
