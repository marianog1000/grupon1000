...
class Controller extends Lib\Base\Controller
{
    ...
    public function index()
    {
        ...
        wp_localize_script( 'bookly-service.js', 'BooklyL10n', array(
            ...
            'service_special_day' => Lib\Config::isSpecialDaysEnabled() && Lib\Config::isSpecialDaysEnabled()
        ) );
    ...
    public function executeUpdateService()
    {
        ...
        $alert = apply_filters( 'bookly_update_service', array( 'success' => array( __( 'Settings saved.', 'bookly' ) ) ), $service, $this->getPostParameters() );
