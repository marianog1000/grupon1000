...
if ( ! empty( $page_ids ) ) {
    ?>
	    ...
	    <section id="ObrasSociales" <?php do_action('onepress_section_atts', 'about'); ?> class="<?php echo esc_attr(apply_filters('onepress_section_class', 'section-about section-padding onepage-section', 'about')); ?>">
        <?php } ?>
            ...
            <div class="container">
				...
				<div class="section-title-area">
					<?php 
					echo '<h2 class="section-title">Obras Sociales</h2>';
					echo '<h5 class="section-subtitle">Trabajamos con las siguientes Obras Sociales</h5>';
