$(document).ready(function() {
	...
	$('.dt-view').each(function () {
		...
		$(this).on('click', function(evt){
			...
			var dtRow = $this.parents('tr');			
			var form = $('<form action="visualizarconsulta" method="post">' +
			  '<input type="text" name="nro_consulta" value="' + dtRow[0].cells[0].innerHTML + '" />' +
	...
	$('.dt-edit').each(function () {
		...
		$(this).on('click', function(evt){
			...
			var dtRow = $this.parents('tr');			
			var form = $('<form action="modificarconsulta" method="post">' +
			  '<input type="text" name="nro_consulta" value="' + dtRow[0].cells[0].innerHTML + '" />' +
			  '<input type="text" name="idd" value="' + varjs +'" />' +
			  '</form>');
			$('body').append(form);
